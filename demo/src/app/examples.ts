/* tslint:disable */
import { ComponentDocsComponent } from './features/code-example/component-docs.component';
import { CodeExampleComponent } from './features/code-example/code-example.component';
import { CodeExampleSetupContainerComponent } from './features/code-example/code-example-setup-container.component';
...
export const EXAMPLES:any[] = [
  ...
  CodeExampleHeaderContainerComponent,
  CodeExampleAboutContainerComponent,
  CodeExampleUsageContainerComponent,
  CodeExampleSetupContainerComponent,
  CodeExampleLiveContainerComponent,
  CodeExampleMainContainerComponent,
  CodeExampleFooterContainerComponent
];
